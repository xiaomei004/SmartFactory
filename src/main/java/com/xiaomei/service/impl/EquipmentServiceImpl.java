...
public class EquipmentServiceImpl implements EquipmentService {
    ...
    public Map<String, String> add(Equipment equipment) {
        ...
        if (equipment.getEquipmentStatus() == null) {
            equipment.setEquipmentStatus(StatusEnum.EQUIPMENT_ENABLED);
        }
    ...
    public Map<String, String> edit(Equipment equipment) {
        ...
        if (equipment.getEquipmentImgUrl() != null) {
            existing.setEquipmentImgUrl(equipment.getEquipmentImgUrl());
        }
        if (equipment.getEquipmentStatus() != null) {
            existing.setEquipmentStatus(equipment.getEquipmentStatus());
        }
